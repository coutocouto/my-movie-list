    ...
    return (
        <div className="container max-w-4xl mx-auto pt-6">
            ...
            <div className="px-3">
                ...
                <button className="bg-white border-2 border-black hover:bg-red-700 hover:text-white text-black font-bold py-2 px-4 rounded-full mt-6">
                    Favorite
                </button>
            </div>
        </div>
...
export async function getStaticProps (context) {
    ...
    const result = await axios(`${server}/${id}?api_key=${process.env.API_KEY}&language=en-US&page=1`);
